...
![GitHub top language](https://img.shields.io/github/languages/top/saintlyzero/movies-api)

RESTful web service to obtain movie information created using Django Restframework<br>
